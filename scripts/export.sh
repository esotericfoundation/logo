...
npx svgexport "./logo/svg/background/logo.svg" "logo/png/background/16x16.png" 16:
npx svgexport "./logo/svg/background/logo.svg" "logo/png/background/32x32.png" 32:
npx svgexport "./logo/svg/background/logo.svg" "logo/png/background/64x64.png" 64:
npx svgexport "./logo/svg/background/logo.svg" "logo/png/background/128x128.png" 128:
npx svgexport "./logo/svg/background/logo.svg" "logo/png/background/512x512.png" 512:
npx svgexport "./logo/svg/background/logo.svg" "logo/png/background/1024x1024.png" 1024:
npx svgexport "./logo/svg/background/logo.svg" "logo/png/background/2048x2048.png" 2048:
npx svgexport "./logo/svg/background/logo.svg" "logo/png/background/4096x4096.png" 4096:
