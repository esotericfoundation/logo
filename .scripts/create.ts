...
const rightTriangleTopLeft: [number, number] = [intersectionRight + Math.sqrt(objectFromTriangleDistance ** 2 / 2), triangleRightLine(intersectionRight + Math.sqrt(objectFromTriangleDistance ** 2 / 2))];
