...
timeout 30s java -jar ./geogebra/desktop/build/install/desktop/lib/desktop.jar --showSplash=false --logLevel=TRACE ./esoteric-foundation-logo.ggb --export=./esoteric-foundation-logo.svg || echo "Timed out while exporting with GeoGebra"
