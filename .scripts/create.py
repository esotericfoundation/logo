...
right_triangle_top_left = (intersection_right + sqrt(((object_from_triangle_distance) ** 2) / 2))

left_triangle_top_right = (intersection_left - sqrt(((object_from_triangle_distance) ** 2) / 2))
...
right_triangle_bottom = (intersection_right_bottom + sqrt(((object_from_triangle_distance) ** 2) / 2))

left_triangle_bottom = (intersection_left_bottom - sqrt(((object_from_triangle_distance) ** 2) / 2))
