...
asy logo -f svg -u 'type = "square-equidistant"; borderRadiusFraction = 0.25' -o './output/logo-square-equidistant'
asy logo -f png -u 'type = "square-equidistant"; borderRadiusFraction = 0.25' -o './output/logo-square-equidistant'
